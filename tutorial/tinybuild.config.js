const config = {
    ...
    server: {  //node server settings, set false to skip server step or add serve:true to config object to only serve (alt methods)
        ...
        port: 9000, //e.g. port 80, 443, 8000
        startpage: "index.html", //home page
        socket_protocol: "ws", //frontend socket protocol, wss for served, ws for localhost
        hotreload: 6000,  //hotreload websocket server port
        ignore: ['demo/dist'],
        ...
        python_node: 8000, //websocket relay port (relays messages to client from nodejs that were sent to it by python)
